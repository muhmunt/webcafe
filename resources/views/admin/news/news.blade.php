                                        ...
                                        <td>
                                            <div class="section__action">
												<div class="list__section__action">
													...
													<a href="{{ route('news.edit', $g->id) }}" class="btn m-btn btn-success btn-sm m-btn--icon m-btn--air icon-only">
														<span>
															<i class="la la-pencil"></i>
														</span>
													</a>
													<a href="{{route('news.destroy',$g->id)}}" class="btn-delete btn m-btn btn-outline-danger btn-sm  m-btn--icon m-btn--pill icon-only">
                                                            <span>
