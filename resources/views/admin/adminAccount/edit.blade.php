...
@section('title','Dashboard | Edit Admin Account')
@section('content')
            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                                <span class="m-nav__link-text">Edit Admin Account</span>
                            </a>
                        </li>
                    </ul>
                </div>
			...
			<div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="m-portlet m-portlet--head-lg">
                        ...
                        <form action="{{ route('adminAccount.update',$admin->id) }}" method="POST" class="m-form m-form--state m-form--label-align-left">
                            @csrf
                            @method('PUT')
                                        ...
                                        <div class="m-form__section">
                                            <div class="form-group m-form__group row">
												...
												<div class="col-lg-6 m-form__group-sub">
													...
													<input type="text" name="name" class="form-control m-input" placeholder="Enter admin Name" value="{{$admin->name}}">
                                                ...
                                                <div class="col-lg-6 m-form__group-sub">
                                                    ...
                                                    <input type="email" name="email" class="form-control m-input" value="{{$admin->email}}" placeholder="Enter admin Email">
                                                    <span class="m-form__help">
                                            ...
                                            <div class="form-group m-form__group row">
												...
												<div class="col-lg-6 m-form__group-sub">
													...
													<input type="password" name="password" class="form-control m-input" placeholder="Enter password" value="{{$admin->password}}">	
													<span class="m-form__help">
                                                ...
                                                <div class="col-lg-6 m-form__group-sub">
                                                    ...
                                                    <input type="password" name="password_confirmation" value="{{$admin->password}}" class="form-control m-input" placeholder="Enter Confirm password">
                                                    <span class="m-form__help">
                                                        Please enter your email
                                                    </span>
                                                </div>
