                      ...
                      <div class="m-widget4">
                        ...
                        <div class="m-widget4__item">
                          <div class="m-widget4__img m-widget4__img--logo">
                            <img
                              src="{{asset('public/assets/app/media/img/client-logos/logo3.png')}}"
                              alt=""
                            />
                          </div>
                        ...
                        <div class="m-widget4__item">
                          <div class="m-widget4__img m-widget4__img--logo">
                            <img
                              src="{{asset('public/assets/app/media/img/client-logos/logo1.png')}}"
                              alt=""
                            />
                          </div>
                          <div class="m-widget4__info">
                        ...
                        <div class="m-widget4__item">
                          <div class="m-widget4__img m-widget4__img--logo">
                            <img
                              src="{{asset('public/assets/app/media/img/client-logos/logo2.png')}}"
                              alt=""
                            />
                          </div>
                          <div class="m-widget4__info">
                  ...
                  >
                    <div class="m-portlet__head m-portlet__head--fit">
                      <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-action">
                          <button
                            type="button"
                            class="btn btn-sm m-btn--pill  btn-brand"
                          >
                            Blog
                          </button>
                        </div>
                    ...
                    <div class="m-portlet__body">
                      <div class="m-widget19">
                        ...
                        >
                          <img
                            src="{{asset('public/assets/app/media/img/blog/blog1.jpg')}}"
                            alt=""
                          />
                          ...
                          <div class="m-widget19__header">
                            <div class="m-widget19__user-img">
                              <img
                                ...
                                src="{{asset('public/assets/app/media/img//users/user1.jpg')}}"
                                alt=""
                              />
                            </div>
