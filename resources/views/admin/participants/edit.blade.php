            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__separator">-</li>
                        <li class="m-nav__item">
                            <a href="{{ route('participants.edit', $participant->id) }}" class="m-nav__link ">
			...
			<div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="m-portlet m-portlet--head-lg">
                        ...
                        <form action="{{ route('participants.update', $participant->id) }}" method="POST" enctype="multipart/form-data" class="m-form m-form--state m-form--label-align-left">
                            @csrf
                            @method('put')
                                        ...
                                        <div class="m-form__section">
                                            <div class="form-group m-form__group row">
												...
												<div class="col-lg-6 m-form__group-sub">
													...
													<input type="text" name="title" class="form-control m-input" value="{{ $participant->title }}">
                                                ...
                                                <div class="col-lg-6 m-form__group-sub">
													...
													<div class="input-group file-input">
														...
														<input class="form-control"  name="picture" type="text" value="{{ $participant->picture }}">
                                            ...
                                            <div class="form-group m-form__group row">
                                                <div class="col-lg-12 m-form__group-sub">
                                                    ...
                                                    <textarea class="summernote" name="description" id="m_summernote_1">{{ $participant->description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
