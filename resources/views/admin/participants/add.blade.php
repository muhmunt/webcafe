			...
			<div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="m-portlet m-portlet--head-lg">
                        ...
                        <form action="{{ route('participants.store') }}" id="form-request" method="POST" enctype="multipart/form-data" class="m-form m-form--state m-form--label-align-left">
                            @csrf
                                        ...
                                        <div class="m-form__section">
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-lg-6 m-form__group-sub has-danger">
                                                        ...
                                                        <input type="text" required name="title" class="form-control m-input" placeholder="Enter text">
                                                ...
                                                <div class="col-lg-6 m-form__group-sub has-danger">
                                                    ...
                                                    <div class="input-group file-input">
                                                        ...
                                                        <input class="form-control" required  name="picture" placeholder="No File Selected" type="text">
...
@section('admin-js')
{!! JsValidator::formRequest('App\Http\Requests\ParticipantGetRequest', '#form-request') !!}
  <script>
